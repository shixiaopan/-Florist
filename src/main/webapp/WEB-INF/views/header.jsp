...
<div id="header-nav">
    <nav class="navbar navbar-default" id="header-nav-middle" style="background-color: #2C639C">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><span class="logo-word">舒城花悦</span></a>
            </div>
