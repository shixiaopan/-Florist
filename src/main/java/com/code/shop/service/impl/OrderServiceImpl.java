...
import com.code.shop.dao.OrderItemMapper;
import com.code.shop.dao.OrderMapper;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public Integer getSumByGoodsId(Integer goodsid) {
        return orderMapper.selectSumByGoodsId(goodsid);
    }
}
