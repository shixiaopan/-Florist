...
import com.code.shop.dao.FavoriteMapper;
import com.code.shop.dao.GoodsMapper;
import com.code.shop.dao.ImagePathMapper;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    @Override
    public List<Goods> findGoodsByActiveId(Integer activityid) {
        return goodsMapper.selectByActivityId(activityid);
    }

    @Override
    public List<FavoriteKey> selectFavByUserId(Integer userid) {
