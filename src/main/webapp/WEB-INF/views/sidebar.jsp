...
<div class="templatemo-sidebar">
    ...
    <nav class="templatemo-left-nav">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/goods/show"><i class="fa fa-bar-chart fa-fw"></i>鲜花管理</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/order/send"><i class="fa fa-users fa-fw"></i>订单管理</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/goods/addCategory"><i class="fa fa-users fa-fw"></i>分类管理</a></li>
